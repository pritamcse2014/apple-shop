            ...
            <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                <div class="product-image">
                    <div class="product_img_box">
                        <img id="product_img1" class="w-100" src="{{asset('assets/images/product_img1.jpg')}}" alt="product_small_img3" />
                    </div>
                    <div class="row p-2">
                        <a href="#" class="col-3 product_img_box p-1">
                            <img id="img1" src="{{asset('assets/images/product_small_img3.jpg')}}" alt="product_small_img3" />
                        </a>
                        <a href="#" class="col-3 product_img_box p-1">
                            <img id="img2" src="{{asset('assets/images/product_small_img3.jpg')}}" alt="product_small_img3" />
                        </a>
                        <a href="#" class="col-3 product_img_box p-1">
